...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        insertProduk(db, "Chitato", "Snack", 123, 1000);
        insertProduk(db, "Beng Beng", "Snack", 123, 1000);
        insertProduk(db, "Oreo", "Snack", 123, 1000);
        insertProduk(db, "Banana Split", "Snack", 123, 1000);
        insertProduk(db, "Indomie", "Food", 123, 1000);
        insertProduk(db, "Ayam Geprek", "Food", 123, 1000);
        insertProduk(db, "Nasi Uduk", "Food", 123, 1000);
        insertProduk(db, "Pecel Lele", "Food", 123, 1000);
    }
    @Override
